...
impl Ffmpeg {
    ...
    pub fn extract_frames(
        ...
        Command::new(FFMPEG)
            .args(&[
                OsStr::new("-v"),
                OsStr::new(&self.verbosity),
                OsStr::new("-i"),
                OsStr::new(input_file),
                OsStr::new(&output_pattern),
            ])
    ...
    pub fn extract_audio(
        ...
        Command::new(FFMPEG)
            .args(&[
                ...
                OsStr::new("-ar"),
                OsStr::new("44.1k"),
                OsStr::new(&audio_path.display().to_string()),
            ])
            .stdout(std::process::Stdio::null())
            .status()
    }
    ...
    pub fn reassemble_video(
        ...
        Command::new(FFMPEG)
            .args(&[
                ...
                OsStr::new(&self.verbosity),
                OsStr::new("-framerate"),
                OsStr::new(&framerate.to_string()),
                OsStr::new("-i"),
                OsStr::new(&input_pattern),
                OsStr::new("-i"),
                OsStr::new(&audio_path.display().to_string()),
                OsStr::new("-c:v"),
                OsStr::new("libx264"),
                ...
                OsStr::new("-pix_fmt"),
                OsStr::new("yuv420p"),
                OsStr::new(&output_path.display().to_string()),
            ])
            .stdout(std::process::Stdio::null())
            .status()
    }
